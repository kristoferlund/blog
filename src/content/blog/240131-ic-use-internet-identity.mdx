---
title: 'Announcing: ic-use-internet-identity'
description: 'Integrate Internet Identity into React applications on the Internet Computer (ICP) platform.'
pubDate: 'Jan 31 2024'
---

import Alert from '../../components/Alert.astro'

[Internet Identity](https://internetcomputer.org/how-it-works/web-authentication-identity) is a service provided by the [Internet Computer](https://internetcomputer.org/) (ICP) that allows users to authenticate themselves anonymously when interaction with ICP applications.

This package is a companion hook to [ic-use-actor](https://kristoferlund.se/blog/240116-ic-use-actor). The hook makes it easy to integrate Internet Identity into React applications. **It provides a simple interface for logging in and out with the Internet Identity service**.
...
[![ic-use-internet-identity](/240131-screendump.png)](https://x2jdf-giaaa-aaaal-qc66a-cai.icp0.io/)
...
<Alert type="tip">For a complete example, see the [ic-use-internet-identity-demo](https://github.com/kristoferlund/ic-use-internet-identity-demo) demo project.</Alert>
